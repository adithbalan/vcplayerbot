...
async def generate_cover(title, thumbnail, result_file_name):
    ...
    try:
        ...
        foreground = Image.open(f"etc/foreground.png")
        ...
        draw.text((985, 20), f"Paattupetti", fill="white", font=KRONA_SMALL)
        draw.text((1100, 50), f"by @wrongtag", fill="white", font=KRONA_SMALL)
